...
public class CS351 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs351);
        ...
        ViewGroup header = (ViewGroup) inflater.inflate(R.layout.header351, listView, false);
        listView.addHeaderView(header);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Courses").child("cs351");
