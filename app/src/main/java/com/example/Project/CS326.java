...
public class CS326 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs326);
        ...
        ViewGroup header = (ViewGroup) inflater.inflate(R.layout.header4, listView, false);
        listView.addHeaderView(header);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Courses").child("cs326");
