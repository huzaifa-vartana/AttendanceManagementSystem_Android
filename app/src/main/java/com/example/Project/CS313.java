...
public class CS313 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs313);
        ...
        ViewGroup header = (ViewGroup) inflater.inflate(R.layout.header313, listView, false);
        listView.addHeaderView(header);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Courses").child("cs313");
